...
public class HandlerProducts extends ProductJDBC {
    ...
    public void updateDatabase() {
        ...
        try {
            ...
            System.out.print("Host["+ DBConnection.getHost() +"]:");
            String host = scanner.nextLine();
            System.out.print("Port["+DBConnection.getPort()+"]:");
            String port = scanner.nextLine();
            System.out.print("Database["+ DBConnection.getDatabase() +"]:");
            String database = scanner.nextLine();
            System.out.print("User["+DBConnection.getUser()+"]:");
            ...
            if(tryParseInt(port)){
               DBConnection.setPort(Integer.parseInt(port));
            }
            if(!database.equals("")){
                DBConnection.setDatabase(database);
            }
            if(!user.equals("")){
                DBConnection.setDatabaseUser(user);
            }
            //password can be empty
            DBConnection.setDatabasePassword(password);
            //reload connection with database
            DBConnection.reloadStringConnection();
            // show changes
